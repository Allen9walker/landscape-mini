...
- If the explicit variables are empty, the build probes the corresponding candidate lists and picks a healthy source, preferring the one with faster representative download speed
